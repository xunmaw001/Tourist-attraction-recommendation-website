...
public class JingdiangoupiaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JingdiangoupiaoEntity jingdiangoupiao, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			jingdiangoupiao.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JingdiangoupiaoEntity jingdiangoupiao, HttpServletRequest request){
        EntityWrapper<JingdiangoupiaoEntity> ew = new EntityWrapper<JingdiangoupiaoEntity>();
		PageUtils page = jingdiangoupiaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jingdiangoupiao), params), params));
        return R.ok().put("data", page);
    }
